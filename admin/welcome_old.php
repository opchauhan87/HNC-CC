...
echo "<title>"._QXZ("HNC Contact Center Welcome")."</title>\n";
        ...
        echo "<div class=\"TextWrap  text-center d-flex align-items-center\" style=\"display: flex;flex-direction: column;justify-content: top;align-items: center;height: 50%;\">";
	    echo "<img src=\"images/logoHNC.png\" style=\"width: 70%;\">";
	    echo "<p style=\"color: #FFD700;font-size: 25px;margin-top: 5px;\">Keeping you always connected<br</p>";

	    echo "<p style=\"color: #ffff;font-size: 10px;margin-top: 50px;\"><br</p>";
	    echo "<p style=\"color: #ffff;font-size: 15px;margin-top: 100px;\">Email: dialerstreet@gmail.com<br>Phone-+91-9679735404</p>";
        ...
        echo "<div class=\"col-sm-6 main-wrap\" style=\"height: 100vh;\">";
      	echo "<div class=\"wrap d-lg-flex d-sm-block\" style=\"\">";
		  	...
		  	echo "<div class=\"main-login\" style='display: flex;flex-direction: column;justify-content: center;margin: auto;width: 100%;text-align: center;'>";
		  	// echo "<img src=\"./images/"._QXZ("logo.png")."\" class=\"Logo mb-3\" alt=\"VICIdial\" style=\"width: 250px;left: 35%;position: relative;\">";
				// echo "<div class=\"w-100\" style='position: relative;left: 39%;'>";
				echo "<img src=\"./images/"._QXZ("logo.png")."\" class=\"Logo mb-3\" alt=\"VICIdial\" style=\"width: 250px;text-align: center;margin: auto;\">";
				echo "<div class=\"w-100\" style='text-align: center;margin: auto;;'>";
					
				echo "</div>";
			echo "</div>";
			
	echo "<form class='form-horizontal' style='margin-bottom: 0px !important;'>";
		// echo "<div class=\"row\" style='background: lightgray;padding: 35px 41%;box-shadow: 0 3px 31px -2px rgba(5, 0, 0, 0.2);'>";
		echo "<div class=\"row\" style='background: linear-gradient;box-shadow: 0 3px 31px -2px rgb(5 0 0 / 70%);height: 250px;display: flex;flex-direction: column;justify-content: center;margin: auto;width: 100%;text-align: center;'>";
		
		
			echo "<div class=\"\">";
				echo "<div class=\"input-group\">";
					echo "<a href=\"../agent/index.php\" class='form-control btn btn-primary' style='border-radius: 8px;'>"._QXZ('Agent Login')."</a>";
              	echo "</div>";
        	echo "</div>";
        	
        	echo "<div class=\"\">";
				echo "<div class=\"input-group\">";
					echo "<a href=\"../agent/timeclock.php?referrer=welcome\" class='form-control btn btn-primary'  style='border-radius: 8px;'>"._QXZ('Timeclock')."</a>\n";
              	echo "</div>";
        	echo "</div>";
        ...
        if ($SShopper_hold_inserts > 0){
        	echo "<div class=\"\">";
				echo "<div class=\"input-group\">";
					echo "<a href=\"../admin/hci_screen.php?referrer=wel-come\" class='form-control btn btn-primary'  style='border-radius: 8px;'>"._QXZ('HCI Screen')."</a>\n";
              	echo "</div>";
        	echo "</div>";
		}        
			echo "<div class=\"\">";
		  	echo "<div class=\"input-group\">";
				echo "<a href=\"../admin/admin.php\" class='form-control btn btn-primary' style='border-radius: 8px;'>"._QXZ('Administration')."</a></div>";	
			echo "</div>";
   ...
   ?>
	 ...
	 echo"<div class="whatsapp">";
         echo"<a href="https://wa.me/60104031983" target="_blank">";
          echo"<img src="WhatsApp.svg" alt="WhatsApp Support"></a>";
          echo"<p style="font-size:0.85rem; margin-top:5px;">Chat with us on WhatsApp</p>";
         
	 echo" <a href="https://harapnilai.com">www.harapnilai.com</a>";
	  echo" Phone-+6010-403-1983<br> ";
          echo" 2025 HN Connect. All Rights Reserved.<br>";
